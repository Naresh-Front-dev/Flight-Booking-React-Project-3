...
const BASE_URL = import.meta.env.VITE_API_URL || 'https://backend-keiu.onrender.com';
    ...
    const getApiData = async () => {
        ...
        try {
            const response = await axios.get(`${BASE_URL}/flights?from=${userData.from}&to=${userData.to}&date=${userData.date}&cabin_class=${userData.cabin_class}&min_price=${userData.min_price}&airline=${userData.airline}`);
